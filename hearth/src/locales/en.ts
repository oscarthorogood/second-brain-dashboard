...
export const en = {
	...
	editors: {
		...
		course: {
			heading: "Course",
			noCourses: "No course notes found. This card reads the notes in your Courses folder.",
			course: "Course",
			courseDesc:
				"Which course this card shows. Its lectures and deadlines are gathered from every folder by the course link, not by folder.",
			pinned: "Fix to this course",
			pinnedDesc: "Hide the switcher so the card always shows the course above.",
		},
		calsync: {
			heading: "Calendars",
			headingDesc:
	...
	cards: {
		...
		course: {
			...
			assignmentCount: (n: number) => `${n} ${n === 1 ? "assignment" : "assignments"}`,
			readingCount: (n: number) => `${n} ${n === 1 ? "reading" : "readings"}`,
		...
		detail: {
			...
			dropFilesSub: "Drag and drop attachments",
			writeNotes: "Write notes",
			writeNotesSub: "Your own notes, in a popup",
			searchPages: "Search pages…",
			choosePage: "Choose a page…",
			noPage: "No page chosen",
			clearPage: "Clear the chosen page",
		...
		empty: {
			...
			courseNoCourses: "No course notes found — this card reads your Courses folder",
