...
/** The picture formats Second Brain Dashboard renders as an `<img>` — the "images" group's own
...
/** Whether this file is a picture Second Brain Dashboard can show (see IMAGE_EXTENSIONS). */
